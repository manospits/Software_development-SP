...
rcode st_insert_back2(stphead listh,uint32_t data,uint32_t data2,uint32_t tag); //inserts node in back
...
int st_peek(const stphead listh);                      //returns list's first stnode
int st_peek_back(const stphead listh);                 //returns list's first int
stpnode st_peek_back_node(const stphead listh);                 //returns list's first int
